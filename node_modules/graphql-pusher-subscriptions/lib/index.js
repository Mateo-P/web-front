...
var SubPusher = _interopDefault(require('pusher-js'));
...
class PubSubAsyncIterator {
    constructor(pubsub, channelName, eventNames) {
        this.pubsub = pubsub;
        this.pullQueue = [];
        this.pushQueue = [];
        this.listening = true;
...
class PusherChannel {
    ...
    publish(event, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.pubPusher.trigger(this.channelName, event, payload);
        });
    }
    subscribe(eventName, onMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.channel.bind(eventName, (event) => onMessage(event));
        });
    }
    unsubscribe() {
    ...
    asyncIterator(subjects) {
        return new PubSubAsyncIterator(this, this.channelName, subjects);
    }
}
